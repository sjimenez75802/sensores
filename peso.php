...
<head>
    ...
    <title>Peso</title>
    <link rel="icon" type="image/png" href="img/peso" />
...
<div class="container">
    ...
    <div class="card-body">  
    <div class="p-3 mb-2 bg-secondary text-white h2"   align="center">Obtención de peso corporal</div>
    <div class="container">
  <div class="row">
    <div class="col-sm">
 <!-- aqui poner texto -->
 <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="card-body">
    <h5 class="card-title">Antes de tomar el peso corporal</h5>
  ...
  <div class="card-body">
    <h5 class="card-title">Precuación</h5>
    <p class="card-text"> Si es que balanza recien se conecta a la alimentación se debe esperar 10 segundos para poder tomar el peso</p>
  </div>
</div>
    </div>
    <div class="carousel-item">
  ...
  <div class="card-body">
    ...
    <p class="card-text"> Peso máximo de la balanza 150 kg.</p>
  </div>
</div>
    </div>
  </div>
    ...
    <?php
           //Conexión a la BD
            ...
            if(isset($_POST['eliminar'])){
                ...
                $sql = "DELETE FROM obtencion_peso ";
            ...
            <form method="POST"  id="form_eliminar_" action="peso.php">
...
<div class="container">
  <div class="row">
      ...
      <h4>Contexto</h4>
      <p class="pr-5 text-white-50"> Esta página adquiere el peso corproal en Kilogramos</p>
...
<script type="text/javascript">
        function cargarData(id) {
            if (id == 1) {
                //window.location.href = "/videos/c/index.html";
