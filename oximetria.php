...
<head>
    ...
    <title>PUlso y SpO2</title>
    <link rel="icon" type="image/png" href="img/oxi" />
...
<div class="container">
    ...
    <div class="card-body"> 
    <div class="p-3 mb-2 bg-info text-white h2"   align="center">Medición de Oximetria</div>   
    <div class="container">
  <div class="row">
    <div class="col-sm">
 <!-- aqui poner texto -->
 <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="card-body">
    <h5 class="card-title">Antes de usar el dispositivo</h5>
  ...
  <div class="card-body">
    ...
    <p class="card-text">Cuando el paciente  introdusca el dedo en el sensor se debe esperar alrededor de 10 segundos hasta que el sensor comienze a dar lecturas.</p>
  </div>
</div>
    </div>
    <div class="carousel-item">
  ...
  <div class="card-body">
    ...
    <p class="card-text"> Si no se muestra  ningun valor o no se actualiza se recomienda regresar y cerrar medición</p>
  </div>
</div>
    </div>
  ...
  <div class="card-body">
    ...
    <p class="card-text"> Rango del sensor</p>
  </div>
</div>
    </div>
    ...
    <?php
           //Conexión a la BD
            ...
            if(isset($_POST['eliminar'])){
                ...
                $sql = "DELETE FROM obtencion_pulso_oxi ";
                ...
                if($conexion->query($sql) === true){
                   ...
                   ?>
                    ...
                    <form method="POST" id="form_eliminar_" action="oximetria.php">
...
<div class="container">
  <div class="row">
      ...
      <h4>Contexto</h4>
      <p class="pr-5 text-white-50"> Esta página adquiere el nivel de oxígeno en la sangre y la frecuencia cardíaca </p>
