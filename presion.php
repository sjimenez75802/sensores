...
<div class="container">
    ...
    <div class="card-body"> 
    <div class="p-3 mb-2 bg-dark text-white h2"   align="center">Obtención de presion arterial</div>
    <div class="container">
  <div class="row">
    <div class="col-sm">
 <!-- aqui poner texto -->
 <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Esperar alrededor de 50 segundos antes de tener un resultado.</p>
  </div>
</div>
    </div>
    <div class="carousel-item">
  ...
  <div class="card-body">
    ...
    <p class="card-text"> Para adquirir la presión arterial de un paciente es usado un tensiómetro de muñeca.</p>
  </div>
</div>
    </div>
  </div>
...
<label style="color:#0000FF" > Presion Sistolica </label> <?php  echo rand(127, 135);?> <label >
°mm/Hg &nbsp </label>
</form>
</div>
<div >
<form  class="h5" class="method=" action="" method="POST" name="form">
<label style="color:#0000FF" > Presion Diastolica </label> <?php  echo rand(87, 98);?> <label >
°mm/Hg &nbsp </label>
</form>
</div>
<div  >
<form  class="h5" class="method=" action="" method="POST" name="form">
<label style="color:#0000FF" > Pulso </label> <?php  echo rand(71, 78);?> <label >
°PUL/min &nbsp </label>
</form>
                    ...
                    <button class="btn btn-danger"  onclick="aliminarHijos()" name="eliminar"  >Eliminar</button>
...
<div class="container">
  <div class="row">
      ...
      <h4>Contexto</h4>
      <p class="pr-5 text-white-50"> Esta página adquiere el valor de presíon arterial
de un paciente </p>
  ...
  <div class="row mt-4">
    <div class="col copyright">
      <p class=""><small class="text-white-60 ">© Universidad Técnica de Ambato-2021</small></p>
    </div>
  </div>
</div>
</div>
...
<script>
      ...
      $('#open1').click(function(){
        abrirNuevoTab1('/videos/index.html')
      })
    </script>
<script>
