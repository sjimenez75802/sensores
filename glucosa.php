...
<head>
    ...
    <title>Glucosa</title>
    <link rel="icon" type="image/png" href="img/gg" />
...
<div class="container">
    ...
    <div class="card-body"> 
    <div class="p-3 mb-2 bg-danger text-white h2"   align="center">Medición de glucosa en la sangre</div>
    <div class="container">
  <div class="row">
    <div class="col-sm">
 <!-- aqui poner texto -->
 <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Para esta medición el paciente debera obtner una gota de sangre de su dedo</p>
  </div>
</div>
    </div>
    <div class="carousel-item">
  ...
  <div class="card-body">
    ...
    <p class="card-text"> Para medir el nivel de  glucosa en la sangre se debe  introducir de manera correcta la tira reactiva en el glucómetro .</p>
  </div>
</div>
    </div>
  </div>
     ...
     <?php
           //Conexión a la BD
            ...
            if(isset($_POST['eliminar'])){
                ...
                $sql = "DELETE FROM obtencion_glucosa";
            ...
            ?>
                    ...
                    <form method="POST" id="form_eliminar_" action="glucosa.php">
...
<div class="container">
  <div class="row">
      ...
      <h4>Contexto</h4>
      <p class="pr-5 text-white-50"> Esta página mide el nivel de glucosa en la sangre de el paciente</p>
