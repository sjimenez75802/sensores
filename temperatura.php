...
<head>
    ...
    <link rel="icon" type="image/png" href="img/temp" />
...
<div class="container">
    ...
    <div class="card-body">    
<div class="p-3 mb-2 bg-primary text-white h2"   align="center">Medición de temperatura corporal</div>
...
<div class="container">
 ...
 <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="card-body">
    <h5 class="card-title">Antes de tomar la temperatura</h5>
  ...
  <div class="card-body">
    <h5 class="card-title">Uso del sensor</h5>
    <p class="card-text">Ubicar la mano a 1 centimetro del sensor.</p>
  </div>
</div>
    </div>
    <div class="carousel-item">
    <div class="card text-dark bg-warning mb-3" style="max-width: 18rem;">
  <div class="card-header">Consejo 3</div>
  <div class="card-body">
    <h5 class="card-title">Recomendación</h5>
    <p class="card-text"> Se recomienda esperar algunos segundos hasta obtener  una lectura coherente.</p>
  </div>
</div>
    </div>
  </div>
        ...
        <?php
           //Conexión a la BD
            ...
            if(isset($_POST['eliminar'])){
                ...
                $sql = "DELETE FROM obtencion_temperatura";
                ...
                if($conexion->query($sql) === true){
                    ...
                    <div id="div2" aria-label="Basic example"></div> 
                      <!--  <form class="method="POST" id="form <//?php echo $row['id']; ?>" action="">
                        <span class="border border-success">
                        <label class="p-3 mb-2 h5" for="lnombre" style="color:hsla(0,100%,50%,1);" >Temeperatura Corporal: </label><//?php echo  $row['temp_corporal'];?> <label > °C &nbsp </label>
                    </span>    
                    </form>-->
                    <!-- <input type="hidden" id="tres" name="tres" value="<?php echo $row['temp_corporal']; ?>">                      -->
                    <form method="POST" id="form_eliminar_" action="temperatura.php">
 ...
 <div id="div1" aria-label="Basic example"></div>
    ...
    <div class="col-sm">
      ...
      <div class="card-header">
            <div class="card-body ">
                ...
                <div>
                    <button type="button" type="submit" class="btn btn-success" id="open2" style="font-size: 17px;"
                 ><i class="fas fa-file-pdf"></i> Manual de usuario</button>
                </div>
                <div>
                ...
                <div>
                    ...
                    <button type="button" type="submit" class="btn btn-outline-warning" id="show"
                        style="font-size: 17px;"><i class="far fa-file-image"></i> Galería</button>
                </div>
                <div id="content" class="col-lg-12">

        <div id="element" class="card-body" style="display: none;">
<i id="hide" class="fas fa-sort-up"></i> 
        <div> 

                    <a class="link-primary" id="open1" style="font-size: 17px;" >Videos</a>
                </div>
                <div class="mb-3"> </div>
                <div>
                    <a class="link-dark"  id="open" style="font-size: 17px;" >Imágenes</a>
...
<div class="container">
  <div class="row">
      ...
      <h4>Información</h4>
      <p class="pr-5 text-white-50"> Esta página lee el valor de temperatura</p>
...
<script type="text/javascript">
        function cargarData(id) {
            if (id == 1) {
            //pdf.php"window.location.href = "/videos/c/index.html";
            //window.open("index.php", "ventana1", "width=600,height=200,scrollbars=NO")
            window.open("/videos/c/index.html", '_blank');
            win.focus();
            } else if (id == 2) {
...
<script>
      ...
      $('#open').click(function(){
        abrirNuevoTab('https://lateralbroadcast.000webhostapp.com/')
      })
    </script>
...
<script>
      ...
      $('#open1').click(function(){
        abrirNuevoTab1('https://videos1233.herokuapp.com/')
      })
    </script>
...
<script>
      ...
      $('#open2').click(function(){
        abrirNuevoTab2('manual.php')
      })
    </script>

 <script> 
function aliminarHijos() {
  var padre = document.getElementById("div2");
